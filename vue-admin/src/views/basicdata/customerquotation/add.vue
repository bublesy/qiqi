  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="80px" size="mini" :inline="true">
      ...
      <el-form-item label="销售平方价:" prop="squaredPrice" label-width="100px">
        <el-input-number v-model="form.squaredPrice" size="mini" :precision="2" :controls="false" :min="0" style="width:180px" @change="price" />
      </el-form-item>
      <el-form-item label="箱型计价:" prop="boxPrice" label-width="100px">
        <el-input-number v-model="form.boxPrice" size="mini" :precision="2" :controls="false" :min="0" style="width:180px" @change="box" />
      </el-form-item>
